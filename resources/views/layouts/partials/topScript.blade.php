<!-- Favicon Icon -->
<link rel="icon" type="image/png" href="{{ asset('front/assets/img/favcion.png') }}" />
<!-- Bootstrap CSS -->
...
<!-- Slick nav CSS -->
<link rel="stylesheet" type="text/css" href="{{ asset('front/assets/css/slicknav.min.css') }}" media="all" />
<!-- Iconfont CSS -->
<link rel="stylesheet" type="text/css" href="{{ asset('front/assets/css/icofont.css') }}" media="all" />
<!-- Owl carousel CSS -->

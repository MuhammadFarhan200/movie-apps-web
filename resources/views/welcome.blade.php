        ...
        <header class="pt-4 pb-2 px-5 ">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center">
                    <div class="theme-toggle d-flex gap-2  align-items-center mt-2 me-3">
                            ...
                            @else
                                ...
                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}"
                                        class="btn btn-outline-primary mt-2 ms-3 px-4 font-bold">Register</a>
                                @endif
                            @endauth
                        @endif
                    </div>
        ...
        <div class="container mt-5">
            <div class="row">
                ...
                <div class="col-md-6 text-center">
                    <img src="{{ asset('assets/images/usher.png') }}" alt="Welcome">
                </div>
            </div>
